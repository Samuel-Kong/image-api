...
class Image(Base):
    ...
    # fallback EXIF JSON for everything else
    exif_json = Column(SA_JSON, nullable=True)
    ...
    error = Column(Text, nullable=True)  # nullable since might not have error
